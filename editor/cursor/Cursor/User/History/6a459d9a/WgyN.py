...
# === Purpose: Automate Canvas Grading               ====
# =======================================================
# ( ͡° ͜ʖ ͡°)( ͡° ͜ʖ ͡°)( ͡° ͜ʖ ͡°)( ͡° ͜ʖ ͡°)( ͡° ͜ʖ ͡°)( ͡° ͜ʖ ͡°)( ͡° ͜ʖ ͡°)
                        ...
                        if len(questions_found) > 0:
                            try:
                                ...
                                grading_decisions = find_student_answers(
                                    page, questions_found, grading_decisions, 0, assignment
                                )
...
def get_ai_grading_choice():
    ...
    while True:
        ...
        if choice.strip().lower() == "n":
            ...
            while True:
                choice = input("How do you want to grade with AI? Press (n) for Mr. NiceGuy or (b) for Mr.By the Book book. Press n or b and hit enter: ")
                if choice.strip().lower() == "n":
                    ...
                    if target_q.strip().lower() == "y":
                        while True:
                            ...
                            try: 
                                ...
                                print("ERROR: please enter a valid question number.")
                                continue
                    elif target_q.strip().lower() == "n":
                        ai_mode["mode"] = "niceguy"
                        return ai_mode
                    else:
                        print("ERROR: Please enter (y) or (n) and hit enter.")
                        continue
...
# For new quiz
def find_student_answers(page, questions_found, grading_decisions, reload_counter, assignment):
